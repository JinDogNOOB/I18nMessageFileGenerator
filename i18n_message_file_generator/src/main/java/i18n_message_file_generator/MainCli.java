...
public class MainCli {
	...
	public MainCli() throws IOException {
		...
		I18nTranslator.printLangCodes();
		langTemp = sc.nextInt();
		desLang = I18nTranslator.getLangCode(langTemp);
	...
	public static void test(String srcFileName, String srcLanguage, String desLanguage, String engineName) throws IOException {
		/**
		 * 0 : properties(default)
		 * 1 : json
		 * */
		...
		srcFilePath = System.getProperty("user.dir") + File.separator + srcFileName;
		srcLang = srcLanguage;
